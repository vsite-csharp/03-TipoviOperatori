...
namespace Vsite.CSharp.TipoviOperatori
{
    ...
    class Program
    {
        static void Main()
        {
            ...
            s.a = 21;
            s.b = 7.56;
            // 068 Napisati naredbu za postavljanje vrijednosti nepostojećeg polja c u toj strukturi na proizvoljnu vrijednosti i provjeriti da li se kod može prevesti.
            // s.c = 3; - ne može
            Console.ReadKey();
        }
    }
