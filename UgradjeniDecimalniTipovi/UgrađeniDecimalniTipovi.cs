...
namespace Vsite.CSharp.TipoviOperatori
{
    class Program
    {
        static void Main()
        {
            ...
            float f2 = 1234567990;
            float f3 = 9;
            // 032 Ispisati razlike (f1-f2), odn. (f1-f3) (pomoću formata "{0:F2}" osigurati ispis svih znamenki) i
            // provjeriti točnost ispisa.

            Console.WriteLine(f2-f1);
            Console.WriteLine(f1-f3);
            Console.WriteLine($"{f2-f1:F12}");
            Console.WriteLine($"{f1 - f3:F0}");

            // Primjer binarnog zaokruživanja na rezultat:
            // 033 Definirati dvije varijable: trećina1 i trećina2, tipa double s vrijednostima koje
            // se izračunavaju pomoću izraza 1/3, odn. (1-2/3).
            // Voditi računa da dijeljenje u tim izrazima ne bude cjelobrojno!
