...
namespace Vsite.CSharp.TipoviOperatori
{
    class Program
    {
        static void Main()
        {
            ...
            Console.WriteLine("Double granička vrijednost: min {0} max {1}", double.MinValue, double.MaxValue);
            Console.WriteLine("Float granička vrijednost: min {0} max {1}", float.MinValue, float.MaxValue);
            Console.WriteLine("Decimal granička vrijednost: min {0} max {1}", decimal.MinValue, decimal.MaxValue);
            ...
            Console.WriteLine("(f1-f2) = {0:F2}\n(f1-f3) = {1:F2}", f1-f2, f1-f3); // ispis nije točan
            ...
            double varMaxPutaDva = double.MaxValue;
            double varMinPutaDva = double.MinValue;
            Console.WriteLine("Double max * 2 = {0}\nDouble min * 2 = {1}", varMaxPutaDva*2, varMinPutaDva*2);
            ...
            Console.WriteLine(((double) 0) / 0); // NaN
