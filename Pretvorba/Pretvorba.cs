...
namespace Vsite.CSharp.TipoviOperatori
{
    ...
    class Program
    {
        static void Main()
        {
            ...
            NuklearniFizičar osobaNuklFiz = new NuklearniFizičar();
            ...
            novaOsoba = osoba;
            nuklFizičar = (NuklearniFizičar)novaOsoba; //ne može se promjeniti tip sa Osobe na NuklearniFizičar kada nije objekt konstruiran tog tipa. 
            nuklFizičar.Hodaj();
            nuklFizičar.NapraviBombu();
