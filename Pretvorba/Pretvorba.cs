namespace Vsite.CSharp.TipoviOperatori
{
    ...
    static class Program
    {
        static void Main()
        {
            ...
            osobaNuklFiz = new NuklearniFizičar();
            ...
            // tkomentirati donje naredbe, provjeriti prijavljuje li program pogreške, pokrenuti program i provjeriti rezultat izvođenja.
