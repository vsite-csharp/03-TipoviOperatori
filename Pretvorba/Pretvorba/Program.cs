...
namespace Vsite.CSharp.TipoviOperatori
{
    ...
    class Program
    {
        static void Main()
        {
            ...
            osobaNuklFiz = nuklFizičar; // osobi pridruzujes nulklerni tip, baznom izvedeni
            ...
            nuklFizičar = (NuklearniFizičar)osobaNuklFiz; // rekli smo kompajleru da znamo sto radimo, ova osoba je nuklearni fizicar
            nuklFizičar.NapraviBombu();
            ...
            novaOsoba = osoba;
            // Ovo nebu dobro zavsilo
            nuklFizičar = (NuklearniFizičar)novaOsoba; //inavlid cast exeption
            nuklFizičar.Hodaj();
            nuklFizičar.NapraviBombu();
